...
import { Star, ExternalLink, ShieldCheck, ChevronLeft, ChevronRight, Play, Pause } from "lucide-react";
  ...
  return (
    <section id="testimonials" className="bg-gradient-to-b from-mist/60 via-white to-mist/40 py-20 lg:py-28 relative overflow-hidden">
      ...
      <div className="section relative z-10">
        ...
        <Card3D intensity={10} className="mx-auto max-w-4xl mb-12 rounded-3xl">
        ...
        <div className="flex items-center justify-between mb-6 px-1">
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-bold text-slate-600 hover:text-teal hover:border-teal/30 transition shadow-xs"
          ...
          >
            {reviews.map((review: GoogleReview) => {
              ...
              return (
                <div
                  key={review.reviewId}
                  className="w-full min-w-[290px] sm:min-w-[340px] md:min-w-[360px] flex-shrink-0"
                >
                  <Card3D intensity={12} glareOpacity={0.15} className="h-full rounded-3xl">
