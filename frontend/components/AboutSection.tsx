  ...
  return (
    <section id="about" className="section py-20 lg:py-28">
      <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
        ...
        >
          <div className="relative rounded-[2.5rem] bg-gradient-to-br from-navy via-[#073B5C] to-[#042135] p-8 sm:p-10 text-white shadow-2xl border border-white/10 overflow-hidden hover:shadow-teal/10 hover:border-teal/30 transition-all duration-300">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-6 border-t border-white/15 pt-6 space-y-3 text-sm text-slate-200">
                ...
                <div className="mt-6 pt-4 border-t border-white/15 text-xs text-slate-400 space-y-3">
                  ...
                  {/* Highly Clickable Doctor Instagram Button */}
                  <a
                    href={CLINIC_INFO.urls.doctorInstagram}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="relative z-30 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] px-4 py-2.5 text-xs font-bold text-white shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer pointer-events-auto"
                  >
        ...
        >
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            <div className="h-full rounded-2xl bg-mist p-6 border border-teal/10 hover:border-teal/30 hover:shadow-md transition-all shadow-sm">
