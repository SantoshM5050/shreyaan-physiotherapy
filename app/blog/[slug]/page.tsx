...
import { ChevronRight, Clock, User, ArrowLeft, Stethoscope, Phone, AlertCircle, RefreshCw, BookOpen } from "lucide-react";
      ...
      <main className="flex-grow">
        ...
        {!loading && (error || !post) && (
          <div className="section py-16 max-w-md mx-auto text-center space-y-4">
            <div className="rounded-3xl border border-rose-200 bg-rose-50 p-8 text-rose-800 space-y-3">
              ...
              <div className="pt-2 flex justify-center gap-3">
                <Link
                  href="/blog"
                  className="rounded-full bg-navy px-5 py-2 text-xs font-bold text-white hover:bg-navy/90"
                >
        ...
        {!loading && post && (
          <article className="section py-12 max-w-4xl mx-auto">
            ...
            {/* Featured Image */}
            <div className="my-8 rounded-3xl overflow-hidden shadow-xl border border-slate-200 aspect-[16/9] relative bg-slate-100">
              <Image
            ...
            <div className="mt-8 space-y-6 text-slate-700 leading-relaxed text-base">
              {post.excerpt && (
                <p className="text-lg font-medium text-slate-800 leading-relaxed border-l-4 border-teal pl-4 italic bg-slate-50 py-3 rounded-r-xl">
                  {post.excerpt}
                </p>
              )}

              {/* Render HTML content or paragraph blocks */}
              <div
            ...
            <div className="mt-12 rounded-3xl bg-navy p-6 sm:p-8 text-white flex flex-col sm:flex-row items-center gap-6 shadow-xl">
              ...
              <a
                ...
                className="btn-primary text-xs py-3 px-5 shrink-0 flex items-center gap-2"
              >
                <Phone size={14} />
