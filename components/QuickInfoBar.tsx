...
export default function QuickInfoBar({ t }: QuickInfoBarProps) {
  return (
    <section className="border-y border-teal/15 bg-white relative z-20 shadow-sm">
      <div className="section grid gap-6 py-6 sm:grid-cols-3">
        {/* Hours */}
        ...
        >
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between">
              ...
              <ArrowUpRight size={14} className="text-slate-400 group-hover:text-teal transition-colors" aria-hidden="true" />
            </div>
